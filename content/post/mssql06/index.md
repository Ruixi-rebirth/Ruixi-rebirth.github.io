...
- [DROP](http://ruixi.me/p/mssql06_2/#drop) ：此命令用于从数据库中删除对象。
- [ALTER](http://ruixi.me/p/mssql06_3/#alter) ： 这用于更改数据库的结构。
- [TRUNCATE](http://ruixi.me/p/mssql06_4/#truncate) ： 这用于从表中删除所有记录，包括删除为记录分配的所有空间。
- COMMENT ：用于向数据字典添加注释。
